			...
			<div class="page-content" style="min-height:801px">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li class="active"><a href="javascript:void(0);">地区类别</a></li>
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-stumbleupon-circle font-green-sharp"></i> <span
										class="caption-subject font-green-sharp bold">地区添加</span>
								</div>
							</div>
							<div class="portlet-body">
								<div class="table-responsive">
									<form id="businessForm" class="form-horizontal form-row-seperated form-inline"
										action="${pageContext.request.contextPath}/country/save" method="post" id="createCouponForm"
										novalidate="novalidate">
										<table class="table table-bordered table_sxcondition ">
											<tbody>
												<tr>
													<th width="25%">地区名称：<label style="color:red;">&nbsp;*&nbsp;</label></th>
													<td width="75%" class="lineheight34"><input
														 id="countryname" name="countryname" type="text"
