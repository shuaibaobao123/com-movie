							...
							<div class="portlet light">
								...
								<div class="portlet-body">
									<div class="table-responsive">
										<form action='<c:url value="/movie/save"></c:url>'
											...
											<table class="table table-bordered table_sxcondition">
												<tbody>
													...
													<tr>
														<th width="25%">上映时间：</th>
														<td width="75%" class="lineheight34" style="color: blue;">
															<label  style="color:grey;">默认为当前时间不可修改</label>
														</td>
													</tr>
													...
													<tr>
														...
														<td width="75%" class="lineheight34">
															<select class="form-control input-large" data-placeholder="全部" id="ispay" name="ispay">
																	<option value="0">非会员电影</option>
																	<option value="1">会员电影</option>
																</select>
														</td>
													</tr>
