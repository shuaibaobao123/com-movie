						...
						<div class="portlet light">
							...
							<div class="portlet-body">
								<div class="table-responsive">
									<form class="form-horizontal form-row-seperated form-inline" id="businessForm"	action="${pageContext.request.contextPath}/country/edit"  method="post" id="createCouponForm"
										novalidate="novalidate">
										<!-- <input type="hidden" name="genType" value=""/> -->
										<table class="table table-bordered table_sxcondition ">
											<tbody>
												<tr>
													<th style="min-width: 120px">区域编号：<label
														style="color:red;">&nbsp;*&nbsp;</label></th>
													<td class="lineheight34">${country.id}
													<input type="hidden" id="id" name="id" value="${country.id}">  
													</td>
												</tr>
												<tr>
													<th width="25%">区域名称：<label style="color:red;">&nbsp;*&nbsp;</label></th>
													<td width="75%" class="lineheight34"><input
														id="subjectTitle" id="countryname" name="countryname" type="text"
														class="form-control input-large-plus" value="${country.countryname}"
